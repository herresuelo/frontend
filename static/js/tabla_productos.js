const { createApp } = Vue
  ...
  createApp({
    data() {
      return {
        url:"https://rgproyfinalpy2024.eu.pythonanywhere.com/productos", // Retorna todos los registro de la tabla productos
        productos:[],
        error:false,
        cargando:true
      }
    ...
    methods: {
        ...
        eliminar(id) {
            ...
            const url = 'https://rgproyfinalpy2024.eu.pythonanywhere.com/borrar/'+id;
            var options = {
                method: 'DELETE',
